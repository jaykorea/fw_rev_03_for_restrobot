...
int InitSetBrakeStop(void) 
{
    ...
    PutMdData(PID_E_BRAKE, Com.nRMID, nArray);

    return SUCCESS;    
}
int InitUnSetStopStatus(void) 
{
    int nArray[3];
    ...
    PutMdData(PID_STOP_STATUS, Com.nRMID, nArray);

    return SUCCESS;    
}
int InitSetStopStatus(void) 
{
    int nArray[3];
